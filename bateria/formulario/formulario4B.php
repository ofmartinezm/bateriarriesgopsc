...
if(isset($_POST['actForm4b'])){
    ...
    /* header('location: formulario4B.php'); */
...
<div class="container" style="margin-top:2%;padding: 5%;box-shadow: 0 5px 8px 0 rgba(0, 0, 0, 0.2), 0 9px 26px 0 rgba(0, 0, 0, 0.19);">
        ...
        <div class="table-title">
            ...
            <div class="row alert bg-primary" style="margin-bottom:20px;box-shadow: 0 5px 8px 0 rgba(0, 0, 0, 0.2), 0 9px 26px 0 rgba(0, 0, 0, 0.19);">
                ...
                aspectos de su <s><u>trabajo</u></s>.</p>
        ...
        <div class="row">
                    ...
                    del(los) sitio(s) o lugar(es) donde habitualmente realiza su trabajo.</h4></div>
        </div>
                            ...
                            $listaReferencia=$bateriaDetalle->cargaReferencias($tipoReferencia);
                               ...
                               if ($ordenPregunta == 13) {
                                  echo (imprimeEntreFilas('Para responder a las siguientes preguntas piense en la cantidad de trabaja que usted tiene a su cargo.'));
                                    ...
                                    echo (imprimeEntreFilas('Las siguientes preguntas están relacionadas con la atención a clientes y usuarios.Si la siguiente respuesta es negativa responda el siguiente bloque de preguntas con "No Aplica", de lo contrario seleccione la opción adecuada para cada caso.'));
                                };
   ...
   <input type="submit" name="actForm4b" class="btn btn-success"   value="FINALIZAR ENCUESTA">
    </div>
   </form>
